...
if (isset($_POST['cadastrar'])) {
    ...
    $confirma_senha = mysqli_real_escape_string($conectar, $_POST['confirma_senha']);
...
if (isset($_POST['alterar'])) {
    ...
    $email = mysqli_real_escape_string($conectar, $_POST['email']);
    $nivel_acesso = intval($_POST['nivel_acesso']);
    $nova_senha = mysqli_real_escape_string($conectar, $_POST['nova_senha']);
    ...
    if ($row_check['total'] > 0) {
        ...
        if ($resultado) {
            if (mysqli_affected_rows($conectar) > 0) {
                ...
                $mensagem = "Nenhuma alteração foi feita ou administrador não encontrado.";
                $tipo_mensagem = "warning";
            }
        } else {
